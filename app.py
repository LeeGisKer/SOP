...
def login():
    ...
    if request.method == 'POST':
            ...
            with connection.cursor() as cursor:
                ...
                if user:
                    if check_password_hash(user['password'], password):
                        ...
                        print(f"Password mismatch for user: {email}")  # Debugging statement
                else:
                    error = 'Invalid email or password'
        ...
        print("Login form not submitted via POST")  # Debugging statement
...
def register():
    ...
    if request.method == 'POST':
        ...
        print("No POST request detected on /register")  # Debugging statement
